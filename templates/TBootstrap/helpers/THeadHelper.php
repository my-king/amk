...
class THeadHelper {
    ...
    /**
     * Adiciona meta tag viewport ao head
     */
    public function addMetaViewPort() {
        $this->setMetaTag("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n");
    }

    /**
     * Adiciona meta tag viewport ao head
     */
    public function addMetaHttpEquiv() {
        $this->setMetaTag("<meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\n");
    }
