...
(function(a) {
    a.fn.tablePagination = function(b) {
        var c = {firstArrow: (new Image()).src = "/siscogerencial/public/images/first.gif", prevArrow: (new Image()).src = "/siscogerencial/public/images/prev.gif", lastArrow: (new Image()).src = "/siscogerencial/public/images/last.gif", nextArrow: (new Image()).src = "/siscogerencial/public/images/next.gif", rowsPerPage: 5, currPage: 1, optionsForRows: [5, 10, 25, 50, 100], ignoreRows: [], topNav: false};
        b = a.extend(c, b);
