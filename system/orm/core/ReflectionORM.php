...
class ReflectionORM extends ReflectionClass {
    ...
    public function getAtributosFromColmap() {
    ...
    public function getOneToMany() {
        ...
        foreach ($this->getAtributos() as $atributo) {
            $isOneToMany = (isset($this->propAtributos[$atributo]["OneToMany"])) ? true : false;
            if ($isOneToMany !== false) {
                $OneToMany[] = $atributo;
            }
        }
    ...
    public function getManyToMany() {
        ...
        foreach ($this->getAtributos() as $atributo) {
            $isManyToMany = (isset($this->propAtributos[$atributo]["ManyToMany"])) ? true : false;
