...
class PersistenceORM {
    ...
    /**
     * Faz a persistencia de campos do tipo placa
     * @tutorial PersistenceORM::placa($ObjPersistence, "###-####"); 
     * @example "###-####" = AZQ-7565
     * @param type $persistence
     * @param type $value
     * @return array
     */
    public static function placa($persistence, $value) {
        ...
        if (ValidateORM::notNull($value)) {
            ...
            if (!ValidateORM::placa($value)) {
                PersistenceORM::$erro[] = "Placa invalida!!!";
            }
