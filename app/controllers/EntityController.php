...
class EntityController extends TMetroUI {
    ...
    public function cadastrarEntityFromDatabase() {
        ...
        if (isset($_POST['dal'])) {
            ...
            $this->TPageSecondary('cadastroEntityFromDatabase');
        } else {
            /* CSS */
            ...
            $this->TPageSecondary('cadastroEntityFromDatabaseFiltro');
        }
    }

    public function editar() {
        /* Incluir Biblioteca */
        include_once $this->SECURITY->getSistema()->getEntity() . $this->getParam('file') . '.php';
